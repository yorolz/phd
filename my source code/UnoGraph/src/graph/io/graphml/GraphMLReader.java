...
public class GraphMLReader {
	...
	public static void inputGraph(final StringGraph inputGraph, final String filename) throws IOException {
		FileInputStream fis = new FileInputStream(filename);
		inputGraph(inputGraph, fis, null, null, null);
		fis.close();
	}
	 ...
	 */
	public static void inputGraph(final StringGraph inputGraph, final InputStream graphMLInputStream, String vertexIdKey, String edgeIdKey, String edgeLabelKey)
			throws IOException {
		...
		try {
			...
			// TODO: Vertex[] edgeEndVertices = null; // [0] = outVertex , [1] = inVertex
			...
			while (reader.hasNext()) {
				...
				if (eventType.equals(XMLEvent.START_ELEMENT)) {
					...
					if (elementName.equals(GraphMLTokens.KEY)) {
						...
						// TODO: edgeEndVertices = new Vertex[2];

						for (int i = 0; i < 2; i++) { // i=0 => outVertex, i=1 => inVertex
							if (vertexIdKey == null) {
								// TODO: edgeEndVertices[i] = graph.getVertex(vertexIds[i]);
							} else {
								// TODO: edgeEndVertices[i] = graph.getVertex(vertexMappedIdMap.get(vertexIds[i]));
							}
