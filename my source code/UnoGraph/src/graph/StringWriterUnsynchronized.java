...
public class StringWriterUnsynchronized extends Writer {
	 ...
	 */
	public StringWriterUnsynchronized() {
	 ...
	 */
	public StringWriterUnsynchronized(int initialSize) {
		if (initialSize < 0) {
	 ...
	 *
	 * <p>
	 * Depending on the specification of <tt>toString</tt> for the character sequence <tt>csq</tt>, the entire sequence may not be appended. For instance, invoking the <tt>toString</tt> method of a
	 ...
	 * @since 1.5
	 */
	public StringWriterUnsynchronized append(CharSequence csq) {
		if (csq == null)
			write("null");
		else
			write(csq.toString());
	 ...
	 *
	 * @param csq
	 *            The character sequence from which a subsequence will be appended. If <tt>csq</tt> is <tt>null</tt>, then characters will be appended as if <tt>csq</tt> contained the four characters
	 *            <tt>"null"</tt>.
	 *
	 * @param start
	 ...
	 * @since 1.5
	 */
	public StringWriterUnsynchronized append(CharSequence csq, int start, int end) {
	 ...
	 * @since 1.5
	 */
	public StringWriterUnsynchronized append(char c) {
		write(c);
		return this;
	}
