...
public class Blender {
	...
	public static void main(String[] args) throws Exception {
		...
		ArrayList<PatternFrameCombination> patternFrames = TuPrologUtils.createPatternFrames("pattern_frames.pl");
		ArrayList<Term> deltaFrames = TuPrologUtils.readClauseFile("delta_frames.pl");
		Theory inferenceTheory = TuPrologUtils.createTheoryFromFile("inferences.pl");
		...
		// GraphReadWrite.readAutoDetect(
		// "C:\\Desktop\\bitbucket\\semantic graphs\\horse bird from francisco (original)\\pegasus_from_book_with_namespaces.csv",
		// pegasusSpace);
		...
		Blend.setupSharedVariables(inputSpace, analogies, genericSpace, patternFrames, deltaFrames, inferenceTheory);
