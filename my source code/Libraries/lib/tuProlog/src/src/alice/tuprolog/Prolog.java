...
public class Prolog implements /* Castagna 06/2011 */IProlog, /**/ Serializable {
	 ...
	 *
	 * The default libraries are BasicLibrary, ISOLibrary, IOLibrary, and JavaLibrary
	 */
	public Prolog() {
		this(false, true);
		try {
	 ...
	 *
	 * @param libs
	 *            the (class) name of the libraries to be loaded
	 */
	 ...
	 *            name of the Java class containing the library to be loaded
	 * @param paths
	 *            The path where is contained the library.
	 * @return the reference to the Library just loaded
	 * @throws InvalidLibraryException
	 *             if name is not a valid library
	 */
	 ...
	 *             if the string does not represent a valid term
	 */
	 ...
	 * 
	 * @param state
	 *            - true for enabling the notification of spy event
	 */
	@Override
	 ...
	 * 
	 * @param state
	 *            - true for enabling warning information notification
	 */
	 ...
	 * 
	 * @param state
	 *            - true for enabling exception information notification
	 */
